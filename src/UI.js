...
function buildFleasioUI(state, config, save) {
    ...
    // separate from the full Settings panel.
    ...
    quickMenu.innerHTML = `
        <div style="font-weight:bold;font-size:14px;margin-bottom:10px;text-align:center;">Quick Toggles</div>
    ...
    function setQuickMenuOpen(open) {
        ...
        if (open) {
            ...
            quickMenu.style.transform = "translate(-50%, -50%) scale(0.92)";
